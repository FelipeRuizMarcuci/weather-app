...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "4db34b546670987b551f405bfd282ab6"
        ...
        try:
            ...
            self.display_error(f"Connection error occurred:\n {conn_err}")
        except requests.exceptions.Timeout as timeout_err:
            self.display_error(f"Timeout error occurred:\n {timeout_err}")
        except requests.exceptions.TooManyRedirects as redirect_err:
            self.display_error(f"Too many redirects error occurred:\n {redirect_err}")
